...
public class BankBranchType {
    ...
    @XmlElement(required = true)
    protected BankBranchType.UseDetails useDetails;
     ...
     * @return
     *     possible object is
     *     {@link BankBranchType.UseDetails }
     *
     */
    public BankBranchType.UseDetails getUseDetails() {
        return useDetails;
    }
     ...
     *
     */
    public void setUseDetails(BankBranchType.UseDetails value) {
