...
public class SingletonHttpClientTest {
    ...
    private SingletonHttpClientTest() {
        ...
        try {
            ...
            username = prop.getProperty("portfolio_manager.test.username");
            password = prop.getProperty("portfolio_manager.test.password");
            uri      = prop.getProperty("portfolio_manager.test.uri");
    ...
    public static WebTarget getResource() {
        if(!initialized) {
            SingletonHttpClientTest instance = new SingletonHttpClientTest();
            instance.initialize();
        }
        return resource;
    }
